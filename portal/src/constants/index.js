...
export const INCOMING_CONTACT_REQUESTED = "incoming_contact_requested";
export const ACCEPT_INCOMING_CONTACT = "accept_incoming_contact";
export const INCOMING_CONTACT_ACCEPTED = "incoming_contact_accepted";
export const DECLINE_INCOMING_CONTACT = "decline_incoming_contact";
export const HANGUP_INCOMING_CONTACT = "hangup_incoming_contact";
export const INCOMING_CONTACT_ENDED = "incoming_contact_ended";
